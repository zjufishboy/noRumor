...
exports.getHotNews = exports.getHotSearch = exports.ConsultQuestion = exports.findUsersQuestions = exports.getAllNews = exports.getNewQuestion = exports.getHotQuestion = exports.dao = void 0;
exports.dao = require('./mysql.js');
/*
获取热搜问题
req: req
res: IQuestion[] / Feedback
*/
exports.getHotQuestion = function (req, res) {
    var data = req.body;
    var Ls = [];
    var Ms = [];
    var Feedback = {
    ...
    Ls = exports.dao.getAllQuestions("concern");
    if (Ls.length == 0) {
        ...
        for (var iter = 0; iter < Ls.length; iter++) {
            var temp = {
...
exports.getNewQuestion = function (req, res) {
    ...
    exports.dao.getAllNews('date').then(function (results) {
        Ls = results;
    }, function (err) {
...
res: IQuestion[] / Feedback
*/
exports.findUsersQuestions = function (req, res) {
    var data = req.body;
    var Ls = [];
    //QuestionList
    var Ms = [];
    ...
    //cant find user }
        ...
        exports.dao.findQuestionsbyUid(data.userName).then(function (results) {
            Ls = results;
        }, function (err) {
...
*/
exports.ConsultQuestion = function (req, res) {
    ...
    if (!data.reply) {
        ...
        exports.dao.createNews(rep, NewQue.n_content, NewQue.n_time, NewQue.n_userName).then(function (results) {
...
*/
exports.getHotSearch = function (req, res) {
    var Ms = [];
    var Fs = [];
    var Feedback = {
        status: "default"
    ...
    exports.dao.getAllNews('cocern').then(function (results) {
        Ms = results;
    }, function (err) {
        Feedback.status = "Getting Data Failed";
        return res.json(Feedback);
    });
    for (var iter = 0; iter < Ms.length; iter++) {
