...
const DefaultNewsDetails: INewsDetails = {
  ...
  source: '较真团队',
  experts: '腾讯较真',
  details:"辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容辟谣内容",
  links: '',
};
const quote = {
